...
def hist_similarity(img1, img2, hist_size=256):
    ...
    distanceb = cv2.compareHist(normalize(imghistb1), normalize(imghistb2), 2)
    distanceg = cv2.compareHist(normalize(imghistg1), normalize(imghistg2), 2)
    distancer = cv2.compareHist(normalize(imghistr1), normalize(imghistr2), 2)
...
if __name__ == '__main__':
    img1_path = r'/home/xhh/Desktop/changejson/pics/pic1-10.png'
    img2_path = r'/home/xhh/Desktop/changejson/pics/pic2-2.png'
